    ...
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Fill in the details to add a new product</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Image URL */}
          <FormField label="Image URL" icon={FiImage} error={errors.image}>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={loading || success}
              className="flex-2 flex-1 py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-70
